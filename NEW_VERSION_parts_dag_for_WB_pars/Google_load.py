...
def delete_folder_Task(file_name: str ='Task_Result') -> None:
...
def load_CSV_to_bq() -> None | bool:
    """Load in BigQuery use CSV (StringIO)

    Returns:
        None | bool: Success of the download process
    """
    from NEW_VERSION_parts_dag_for_WB_pars.Object_Сlass_call import read_result
    kwargs = read_result()
